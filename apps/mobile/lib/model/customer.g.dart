...
extension CustomerQueryFilter
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> receivedEqualTo(
    bool value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'received', value: value),
      );
    });
  }
...
extension CustomerQuerySortBy on QueryBuilder<Customer, Customer, QSortBy> {
  ...
  QueryBuilder<Customer, Customer, QAfterSortBy> sortByReceived() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'received', Sort.asc);
    });
  }

  QueryBuilder<Customer, Customer, QAfterSortBy> sortByReceivedDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CustomerQuerySortThenBy
  ...
  QueryBuilder<Customer, Customer, QAfterSortBy> thenByReceived() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'received', Sort.asc);
    });
  }

  QueryBuilder<Customer, Customer, QAfterSortBy> thenByReceivedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'received', Sort.desc);
    });
  }
...
extension CustomerQueryWhereDistinct
  ...
  QueryBuilder<Customer, Customer, QDistinct> distinctByReceived() {
    return QueryBuilder.apply(this, (query) {
...
extension CustomerQueryProperty
  ...
  QueryBuilder<Customer, bool, QQueryOperations> receivedProperty() {
    return QueryBuilder.apply(this, (query) {
