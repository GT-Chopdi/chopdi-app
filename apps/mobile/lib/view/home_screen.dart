...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // IMPORTANT:
  // Separate FAB state for each tab.
  final ValueNotifier<bool> _gaveFabSmallNotifier =
  ValueNotifier<bool>(false);

  final ValueNotifier<bool> _tookFabSmallNotifier =
  ValueNotifier<bool>(false);
  ...
  void dispose() {
    ...
    _gaveFabSmallNotifier.dispose();
    _tookFabSmallNotifier.dispose();
  ...
  bool _handleScrollNotification(
    ...
    if (notification is UserScrollNotification &&
      ...
      isGaveLoan
          ? _gaveFabSmallNotifier
          : _tookFabSmallNotifier;
  ...
  // ============================================================
  // GET CURRENT TAB FAB NOTIFIER
  // ============================================================

  ValueNotifier<bool> _currentFabNotifier() {
