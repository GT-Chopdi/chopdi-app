...
//     // Responsive horizontal margin/padding
//     final horizontalMargin = screenWidth < 360 ? 8.0 : 12.0;
//     final horizontalPadding = screenWidth < 360 ? 18.0 : 24.0;

//     // Never allow the bottom sheet to become too tall.
//     // On smaller screens, it can scroll.
          ...
          child: OutlinedButton.icon(
            onPressed: () async {
              final result =
                ...
                onDelete: () async {
                  // Voided, not removed: a hard delete cannot reach another
                  // device and destroys the audit history.
                  // Every read filters voidedAt, so it disappears from the UI.
