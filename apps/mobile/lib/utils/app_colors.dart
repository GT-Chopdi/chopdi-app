...
class ChopdiColors {
  ...
  static const Color shadow = Color(0x99000000); // black at ~60% opacity
}

class AppColors {
  static const background = Color(0xffFFF3E2);
  static const primary = Color(0xff243B67);
  static const lightBlue = Color(0xffEEF4FF);
  static const green = Color(0xff56D34E);
  static const red = Color(0xffE53935);
  static const grey = Color(0xff7A7A7A);
  static const border = Color(0xffD5D5D5);
  static const card = Color(0xFFFFF8F0);
}